...
model:add(nn.View(-1, 2048*4*4))
cc = nn.ConcatTable()
lin3 = nn.Linear(2048*4*4, 21)
lin3.weight:normal(0, 0.01)
lin3.bias:fill(0)

cc:add(lin3)
lin4 = nn.Linear(2048*4*4,84)
...
torch.save ('/data/ethierer/ObjectDetection/FasterRCNN/Model/FastRCNN/Res50_Fast_Rcnn_128.t7', model)
