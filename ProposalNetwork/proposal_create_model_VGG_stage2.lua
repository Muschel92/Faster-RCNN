...
model = torch.load('/data/ethierer/ObjectDetection/FasterRCNN/Model/model_stage3/VGG16_Mo3Okt_ep16.t7')
...
torch.save ( '/data/ethierer/ObjectDetection/FasterRCNN/Model/ProposalNetwork/stage_2/' .. 'VGG16_Mo3Okt_ep16.t7', model)
